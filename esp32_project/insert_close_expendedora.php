...
if (!isset($data['device_id']) || !isset($data['dato1']) || !isset($data['dato2']) || !isset($data['dato3']) || !isset($data['dato4'])) {
...
$sql = "INSERT INTO datos (device_id, dato1, dato2, dato3, dato4, dato5) VALUES (?, ?, ?, ?, ?, ?)"; //del dato 3 al 5 se van a usar para los reportes de las promociones 
